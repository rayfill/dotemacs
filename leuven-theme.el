...
(custom-theme-set-faces
 ...
 '(gnus-group-mail-low ((((class color) (min-colors 89)) (:slant italic :strike-through t :foreground "gray55"))))
 '(gnus-group-mail-low-empty ((((class color) (min-colors 89)) (:slant italic :strike-through t :foreground "gray55"))))
